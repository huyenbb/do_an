...
<body>
    ...
    <script src="{{asset('assets')}}/js/validatecreateadmin.js"></script>
    <script src="{{asset('assets')}}/js/validateThemTour.js"></script>
    <script src="{{asset('assets')}}/js/validateThemmaybay.js"></script>
    <script src="{{asset('assets')}}/js/validatethemkhachsan.js"></script>
    <script src="{{asset('assets')}}/js/validateDiaDiem.js"></script>
    <script src="{{asset('assets')}}/js/validateBaiViet.js"></script>
